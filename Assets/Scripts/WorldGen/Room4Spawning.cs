...
public class Room4Spawning : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            GameObject spawnthis = Instantiate(randEnemyList[i], Room4Prefab.transform);
